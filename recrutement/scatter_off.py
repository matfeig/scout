...
df= df.loc[(df.primary_position == "Centre Forward")|(df.primary_position == "Left Centre Forward")|(df.primary_position == "Right Centre Forward")|
           ...
           (df.primary_position == "Left Attacking Midfielder")|(df.primary_position == "Right Attacking Midfielder")|(df.secondary_position == "Centre Attacking Midfielder")]
...
fig_text(
    x = 0.45, y = 0.90, 
    s = "Expected Goals & Expected Assits",
    #highlight_textprops=[{"color":"#F64740", "style":"italic"}],
    va = "bottom", ha = "right",
    fontsize = 20, color = "black", font = "Karla", weight = "bold"
)
