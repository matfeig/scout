...
dfns=df[df["competition_name"] != "Super League"]
df

df_fw_list=list(dfns["player_name"])
df_fw_list

df1=df.replace(to_replace=df_fw_list,value="")
df1

df1=df1.drop(columns=["Unnamed: 0","team_name","competition_name"])
df1
