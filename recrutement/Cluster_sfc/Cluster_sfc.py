...
df.to_csv('/Users/matfeig/Dropbox/SFC/Database/player_season/cluster/df.csv')


## Selectionner les positions pour faire le cluster
df= df.loc[(df.primary_position == "Centre Forward")|(df.primary_position == "Left Centre Forward")|(df.primary_position == "Right Centre Forward")|
           (df.secondary_position == "Centre Forward")|(df.secondary_position == "Left Centre Forward")|(df.secondary_position == "Right Centre Forward")|
           (df.primary_position == "Left Wing")|(df.primary_position == "Right Wing")|(df.primary_position == "Centre Attacking Midfielder")|
           (df.primary_position == "Left Attacking Midfielder")|(df.primary_position == "Right Attacking Midfielder")]
...
## Faire un premier test avec un grand nombre de variables 
# df_input = df[['competition_name','player_season_np_xg_90','player_season_xa_90','player_season_through_balls_90','player_season_op_passes_into_box_90',
#                 'player_season_touches_inside_box_90','player_season_padj_tackles_90','player_season_padj_interceptions_90','player_season_dribbles_90',
#                 'player_season_dribbled_past_90','player_season_dispossessions_90','player_season_padj_clearances_90','player_season_aerial_wins_90',
#                 'player_season_op_passes_90','player_season_forward_pass_proportion','player_season_op_f3_passes_90','player_season_crosses_90','player_season_op_xgbuildup_90',
#                 'player_season_pressures_90','player_season_turnovers_90','player_season_deep_progressions_90','player_season_carries_90', 'player_season_average_x_defensive_action',
#                 'player_season_obv_pass_90','player_season_obv_shot_90','player_season_obv_dribble_carry_90','player_season_deep_completions_90',
#                 'player_season_np_psxg_90','player_season_ball_recoveries_90']]
...
df_input = df[['competition_name',
               'player_season_np_xg_90','player_season_np_psxg_90','player_season_np_shots_90',
...
### Add N_init####
kmeanModel = KMeans(n_clusters=5,n_init=100,random_state=0)
kmeanModel.fit(df_scaled)
