...
df2 = pd.read_csv("/Users/matfeig/Library/CloudStorage/Dropbox/SFC/Database/player_match/23_24/SFC_Roma.csv")
df1 = pd.read_csv("/Users/matfeig/Library/CloudStorage/Dropbox/SFC/Database/event_match/23_24/SFC_Roma.csv")
...
for player_name in servette_players:
    ...
    ax['pitch'].text(0.26, 1, f"Ratio réussi: {ratio:.2%}", 
...
for player in servette_players:
    ...
    fig.suptitle("Jeu dynamique", fontsize = 22, fontweight = "bold")
...
for player in servette_players:
    ...
    # Additional mask to ensure only events during 'Regular Play' are considered
    mask_regular_play = df_player['play_pattern_name'] == "From Goal Kick"
    df_player = df_player.loc[mask_regular_play, :]
    ...
    fig.suptitle("Jeu Statique", fontsize = 22, fontweight = "bold")
