...
df2['player_name'] = df2['player_name'].replace({
    'Chris Bedia': 'Chris Vianney Bedia',
    'Jérémy Guillemenot': 'Jeremy Bruno Guillemenot'
})
###Clean data  ####
...
desired_positions = ["Center Forward", "Right Wing", "Left Wing", "Left Center Forward", "Right Center Forward","Center Attacking Midfield", "Left Midfield", "Right Midfield", "Right Wing Back","Left Center Midfield",'Right Midfield']
...
#servette_players = np.delete(servette_players, 7, axis=0)
...
team_total_xg = df1[(df1['team_name'] == "Servette") & (df1['event_type_name'] == 'Shot')]['statsbomb_xg'].sum()
...
player = ["Bendegúz Bolla", "Dereck Germano Kutesa","Jeremy Bruno Guillemenot", "Alexis Antunes", "Miroslav Stevanović"]
